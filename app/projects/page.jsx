              ...
              <Button
                ...
                className={
                  activeFilter === category
                    ? "bg-[#009BDE] text-black hover:bg-[#009BDE] transform hover:scale-105 transition-all duration-200"
                    : "border-gray-600 text-gray-300 hover:border-[#009BDE] hover:text-[#009BDE] bg-transparent transform hover:scale-105 transition-all duration-200"
                }
              >
        ...
        <div className="transition-all duration-500 ease-in-out">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="group relative overflow-hidden bg-black border border-gray-700 hover:border-[#009BDE]/50 transition-all duration-300 cursor-pointer transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-[#009BDE]/10">
                  <div className="aspect-[4/3] relative">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className="bg-[#009BDE]/90 text-black font-sans text-xs font-semibold px-2 py-1 rounded transform group-hover:scale-110 transition-transform duration-200">
                        {t(`projects.categories.${project.category}`)}
                      </span>
                    </div>
                  </div>
                  <div className="p-6">
                    <h2 className="text-xl font-sans text-white group-hover:text-[#009BDE] transition-colors mb-2">
                      {project.name}
                    </h2>
                    <div className="flex items-center text-gray-400 group-hover:text-gray-300 transition-colors">
                      <MapPin className="h-4 w-4 mr-2 group-hover:text-[#009BDE] transition-colors" />
