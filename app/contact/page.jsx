...
const contactInfo = [
  {
    ...
    description: "Experience our furniture collections in person across multiple locations in the region.",
    details: "Riyadh • Jeddah • Tabuk • Najran",
  },
  {
    icon: Phone,
    title: "Call Us",
    description: "Speak directly with our design consultants for personalized assistance.",
      ...
      <Section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-black via-gray-900 to-black">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          <AnimatedContainer animation="fade-in" delay={200}>
            <p className="text-yellow-400 font-semibold text-lg mb-4">Contact us</p>
          </AnimatedContainer>
          ...
          <AnimatedContainer animation="fade-in" delay={600}>
            <Text size="lg" className="max-w-3xl mx-auto">
              Whether you're furnishing a single room, a new home, or an entire project, our team is here to guide you.
            </Text>
          </AnimatedContainer>
        </div>
      </Section>
            ...
            <div>
              ...
              <div className="space-y-8">
                {contactInfo.map((info, index) => (
                  <AnimatedContainer key={info.title} animation="fade-in" delay={index * 100}>
            ...
            <div className="bg-black/50 border border-gray-700 rounded-lg p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                  By pressing the submit button, I agree to Riyash contacting me by email. I also understand that any
                  information I've shared in this form is subject to Riyash privacy policy.
                </p>
              </form>
            </div>
          </AnimatedContainer>
        ...
        <AnimatedContainer animation="fade-in">
          <div className="text-center mb-12">
            ...
            <Text className="text-gray-300 max-w-2xl mx-auto">
              Experience our furniture collections in person at our showrooms across the region. Each location offers
              the full Riyash gallery experience.
            </Text>
          </div>
